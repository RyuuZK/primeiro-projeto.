...
1. Instale a biblioteca do Pyxel:
   ```bash
   pip install pyxel
Certifique-se de ter os seguintes arquivos de imagem na mesma pasta do código:mapa.png (Cenário de fundo)blastoise.png, venusaur.png, charizard.png (Sprites das torres)rattata.png, raticate.png, articuno.png, mew.png (Sprites dos inimigos)Rode o script principal:Bashpython nome_do_seu_arquivo.py
